...
- **Starter Cat Companion ("Neko")**:
  ...
  - **Grooming**: Sits upright and licks paw / washes face.
...
- **Full Control**:
  - Right-click anywhere on the pet for quick actions, scale (1x, 2x, 3x, 4x), speed, and settings.
